...
func TestCreateAudience(t *testing.T) {
	...
	assert.Equal(t, resp.Object, "audience")
...
func TestRemoveAudience(t *testing.T) {
	...
	mux.HandleFunc("/audiences/b6d24b8e-af0b-4c3c-be0c-359bbd97381e", func(w http.ResponseWriter, r *http.Request) {
	...
	assert.Equal(t, deleted.Object, "audience")
}
...
func TestGetAudience(t *testing.T) {
	...
	mux.HandleFunc("/audiences/d91cd9bd-1176-453e-8fc1-35364d380206", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
	...
	assert.Equal(t, audience.Object, "audience")
