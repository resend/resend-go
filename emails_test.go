...
func TestGetEmail(t *testing.T) {
	...
	assert.Equal(t, resp.MessageId, "<lc2vu8.gpa9o4@email.example.com>")
...
func TestListEmails(t *testing.T) {
			...
			Data: []Email{
				{
					Id:        "1",
					Object:    "email",
					MessageId: "<msg-1@email.example.com>",
				...
				},
				{
					Id:        "2",
					Object:    "email",
					MessageId: "<msg-2@email.example.com>",
	...
	assert.Equal(t, "<msg-1@email.example.com>", resp.Data[0].MessageId)
